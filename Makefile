...
#########################################################
# link script
LDSCRIPT = "SW4STM32/stm32f0_discovery_adc/STM32F051R8Tx_FLASH.ld"
# libraries
LIBS = -lc -lm -lnosys
LIBS += 
LIBDIR =
...
LDFLAGS = -mthumb -mcpu=cortex-m0 $(LDSPECS) -T$(LDSCRIPT) $(LIBDIR) $(LIBS) -Wl,-Map=$(BUILD_DIR)/$(TARGET).map,--cref -Wl,--gc-sections
